...
class Geometry final {
    public:
        ...
        static std::vector<ColorVertex> createSphere(const float & radius, const uint16_t & latIntervals, const uint & lonIntervals, const glm::vec3 & color = glm::vec3(255.f, 255.f, 255.f));
